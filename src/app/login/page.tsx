...
export default function LoginPage() {
  ...
  return (
    <div
      className={`min-h-screen bg-[#050505] flex flex-col items-center justify-center p-4 relative overflow-hidden selection:bg-cyan-500/30 ${inter.className}`}
    >
      <BackgroundOrbs />
      ...
      <div className="w-full max-w-md relative z-10 my-auto">
        ...
        >
          ...
          <p className="text-gray-400 text-sm">
            Welcome back to the future of delivery.
          </p>
        </motion.div>
          ...
          <form onSubmit={handleLogin} className="space-y-6">
            ...
            >
              <label className="flex items-center gap-2 cursor-pointer">
                <input
                  type="checkbox"
                  className="w-4 h-4 rounded border-gray-700 bg-black/40 text-cyan-500 focus:ring-cyan-500/50 focus:ring-offset-0"
                />
      ...
      >
        <div className="text-center mb-8">
          <p className="text-xs font-semibold text-cyan-500 tracking-[0.2em] uppercase mb-2">
            The Pluggd Advantage
          </p>
