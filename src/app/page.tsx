      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-6 pt-20">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-8 inline-flex items-center gap-3 p-1.5 pr-4 rounded-full bg-glass-bg border border-glass-border backdrop-blur-md"
          >
            <span className="px-2.5 py-1 rounded-full bg-accent text-white text-xs font-bold uppercase tracking-wider">
              NEW
            </span>
          ...
          >
            ...
            <br />
            One Rapid{" "}
            <span className="font-serif italic text-white/90">Interface</span>.
          </motion.h1>
          ...
          >
            Platform helps admins control access, logs, and servers with
            purpose.
          </motion.p>
