...
import { LayoutDashboard, Package, UserCheck, CalendarCheck, DollarSign, LogOut, Zap, UserCircle, MessageSquare, Menu, X } from 'lucide-react'
    ...
    <>
      <div className="p-6 pb-4">
        ...
        <div className="mt-1 ml-[42px]">
          <span className="text-[10px] font-medium text-zinc-500 uppercase tracking-widest">Founder</span>
        </div>
      </div>
